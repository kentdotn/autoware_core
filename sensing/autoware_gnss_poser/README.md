...
| `latest_outcome`                      | what the latest NavSatFix produced: `NoProjectorInfo`, `LocalProjector`, `NotFixed`, `Buffering`, `NoAntennaTransform` or `Published`. | `NotFixed`                                                                                  | `LocalProjector`                                            |
| `position_buffer_size`                | number of positions in the averaging / median buffer.                                                                                  | none                                                                                        | none                                                        |
| `is_antenna_transform_available`      | whether the latest TF lookup from the antenna frame to `base_frame` succeeded.                                                         | none                                                                                        | failed (fixes are skipped until the transform is available) |

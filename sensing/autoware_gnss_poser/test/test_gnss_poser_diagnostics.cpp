...
// Only a poser that holds fixes back reports a count; the static one never does.
...
// A fix that produced no pose for lack of its antenna transform is an error, the message names
// both frames, and it supersedes the warning about fixes still waiting.

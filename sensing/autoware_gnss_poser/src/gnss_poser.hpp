...
// The rclcpp-free part of the GNSS poser: it turns GNSS fixes into base_link poses. Everything
// here takes and returns message types but needs no node, clock, TF listener or publisher.
